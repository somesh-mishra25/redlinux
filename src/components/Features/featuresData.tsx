...
const featuresData: Feature[] = [
  {
    ...
    image: "/images/monitoring-mastery.png",
    title: "Monitoring Mastery",
    paragraph:
      "Seamlessly detect and debug infrastructure pain points with our integrated monitoring solutions.",
    description:
      "Ensure uninterrupted operations with our comprehensive Infrastructure Monitoring Services. Our integrated solutions empower developers and administrators to swiftly identify and resolve pain points within your infrastructure, ensuring seamless performance and productivity.",
    points: [
  ...
  },
  {
    ...
    image: "/images/devops-dynamics.png",
    title: "DevOps Dynamics",
    paragraph:
      "Unlock cloud potential with end-to-end DevOps services, tailored for AWS, GCP, and Azure.",
    description:
      "Maximize cloud efficiency with our advanced DevOps services. Tailored for AWS, GCP, and Azure, our solutions cover everything from roadmap development to continuous integration and deployment, optimizing your cloud journey for maximum ROI and innovation.",
    points: [
  ...
  },
  {
    ...
    paragraph:
      "Redefine cloud infrastructures with scalable designs leveraging containerization on AWS, Azure, and Google.",
    description:
      "Redefine your cloud infrastructure with our Cloud Architecture and Design Implementation services. Whether scaling existing architectures or migrating legacy applications, we leverage containerization and leading cloud platforms to drive innovation and agility in your operations on AWS, Azure, and Google.",
    points: [
      "Cloud Migration",
      "Containerization",
      "Scalable Designs",
  ...
  },
  {
    ...
    image: "/images/web-wizardry.png",
    title: "Web Wizardry",
    paragraph:
      "Accelerate digital presence with bespoke web development in cutting-edge languages and frameworks.",
    description:
      "Elevate your digital presence with our top-notch Web Development services. Our skilled engineers specialize in various languages and frameworks, including Node.js/Typescript, Python/Django, and Angular/React/Next.js, crafting bespoke solutions tailored to your unique requirements and ensuring a standout online presence.",
    points: [
      "Node.js/Typescript",
      "Python/Django",
  ...
  },
  {
    ...
    image: "/images/kubernetes-migration.png",
    title: "Kubernetes Migration",
    paragraph:
      "Effortlessly transition to Kubernetes clusters with our expert migration plans and certified administrators.",
    description:
      "Simplify your transition to Kubernetes clusters with our expert guidance. Our certified Kubernetes Administrators provide comprehensive migration plans, ensuring smooth deployment, scalability, and high availability of your services within Kubernetes environments.",
    points: [
  ...
  },
  {
    ...
    image: "/images/mobile-app-marvels.png",
    title: "Mobile App Marvels",
    paragraph:
      "Elevate user engagement with custom iOS and Android app development tailored to your business needs.",
    description:
      "Enhance user engagement and expand your reach with our Mobile App Development Services. Our expert team specializes in crafting custom iOS and Android applications, delivering seamless experiences that align with your business goals and captivate your audience on both platforms.",
    points: [
      "iOS Development",
      "Android Development",
      "Custom Applications",
